...
<table id="event_tickets" class="eventtable">
	...
	<tr>
		<td colspan="2" class="tribe_sectionheader">
			...
			<a href="#" class="button-secondary"
			   id="parking_form_toggle"><?php _e( 'Add parking pass', 'tribe-events-calendar' );?></a>
		</td>
	</tr>
		...
		<td colspan="2" class="tribe_sectionheader">
			...
			<table id="ticket_form_table" class="eventtable ticket_form">
				...
				<tr>
					...
					<td>
						<?php do_action('tribe_ticket_table_top', $postId); ?>
						<!-- input type='text' id='ticket_name' name='ticket_name' class="ticket_field" size='25' value='General Admission + Lifetime Membership' /> -->
					</td>
				</tr>
				<tr class="ticket">
					<td><label
					...
					<td>
						<textarea rows="5" cols="40" name="ticket_description" class="ticket_field"
								  id="ticket_description">Choose this ticket if you are not already a member or if you will not be the guest of a Member of Motorco, a private club with full liquor licenses as defined and regulated by the NC ABC laws.
						</textarea>
					</td>
				</tr>
				<tr class="ticket">
