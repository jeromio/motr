...
<!-- Mike Start - list.php -->
		...
		<span class='tribe-events-button'> 
			<a class='tribe-events-button-active' href='<?php echo tribe_get_listview_link(); ?>'>Event List</a>
		</span>
		<span class='tribe-events-button'> 
			<a class='tribe-events-button-inactive' href='<?php echo tribe_get_gridview_link(); ?>'>Calendar</a>
		</span>
		...
		<span class='tribe-events-button'> 
	 		<a class='tribe-events-button-inactive' href="webcal://motorcomusic.com/?ical=<?php echo $tecCatObject->slug; ?>">
				iCal Import</a>
		</span>
<!-- Mike End -->
