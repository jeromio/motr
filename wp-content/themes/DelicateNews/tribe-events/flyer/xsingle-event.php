<?php 
/**
 * Flyer View Single Event
 * This file contains one event in the flyer view
 */
...
</div> <!-- .flyer-event-heading -->

<!-- Event Content -->
<?php do_action( 'tribe_events_before_the_content' ) ?>
<div class="tribe-flyer-event-description tribe-content">
	<?php echo tribe_event_featured_image(null, 'large'); ?>
	<?php the_content() ?>
</div><!-- .tribe-flyer-event-description -->
