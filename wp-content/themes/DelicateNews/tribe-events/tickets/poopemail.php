...
<div style="margin:0; padding:0; width:100% !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-size:14px; line-height:145%; text-align:left;">
	<center>
		...
		<p>Your tickets are attached to this email as a PDF file. Youi can open up the PDF file in an appropriate viewer program (such as Adobe Acrobat or Preview) 
		and print them out. Or you can open up the PDF file on your smart phone. Just make sure that the 2D Barcode is zoomed in big on your screen to make it 
		easier for our door person to scan you in quickly. Thanks and enjoy the show! </p>
		<?php
		...
		foreach ( $tickets as $ticket ) {
			...
			//////////////////////PDF
			QRcode::png($ticket['security_code'], $qrcode_filenames[$count]); // output to buffer
	...
	<img src="<?php echo esc_attr( $header_img[0] ); ?>" width="<?php echo $header_width; ?>" alt="<?php echo esc_attr( $event->post_title ); ?>" style="border:0; outline:none; height:auto; max-width:100%; display:block;" />
								...
								<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
									<tr>
										...
										<TD.ticket-qr><?php
										echo "<img src=\"".$qrcode_filenames[$count]."\" alt=\"barcode\"";
										?></TD>
									</tr>
								</table>
									...
									<tr>
										...
										<td class="ticket-details new-row new-left-row" valign="top" align="left" width="120" style="padding: 0; width:120px; margin:0 !important;">
											<h6 style="color:#909090 !important; margin:0 0 10px 0; font-family: 'Helvetica Neue', Helvetica, sans-serif; text-transform:uppercase; font-size:13px; font-weight:700 !important;">
												<?php _e( "Security Code", "tribe-events-calendar" );?></h6>
