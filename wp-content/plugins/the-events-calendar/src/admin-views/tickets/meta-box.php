		...
		<td colspan="2" class="tribe_sectionheader">
			...
			<table id="ticket_form_table" class="eventtable ticket_form">
				...
				<tr class="ticket">
					...
					<td>
						<textarea rows="5" cols="40" name="ticket_description" class="ticket_field"
								  id="ticket_description" placeholder="General Admission for Members or Guests of Members."></textarea>
					</td>
				</tr>
				<tr class="ticket">
					<td><label
					...
					<td>
						<input type='text' id='ticket_price' name='ticket_price' class="ticket_field" size='7'
							   value='' />
						/<input type='text' id='dayof_price' name='dayof_price' class="ticket_field" size='7'
							   value='' />

						<p class="description"><?php esc_html_e( '(adv/day-of)', 'the-events-calendar' ) ?></p>
					</td>
				</tr>
				...
				<tr class="ticket bottom">
					...
					<td>	<!-- JER added parking & memberships -->		
						<input checked( "false" ) type="checkbox" name="parking_pass" id="parking_pass" value="1" class="ticket_field">
							<span>Add Parking</span>
						<input checked( "false" ) type="checkbox" name="membership" id="membership" value="1" class="ticket_field">
