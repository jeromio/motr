...
class TribeEventsTicketsAttendeesTable extends WP_List_Table {
	...
	function extra_tablenav( $which ) {
		...
		if ( 'top' == $which ) {
			...
			echo sprintf( '%s: <input type="text" name="filter_attendee" id="filter_attendee" value="">', __( "Name, ticket #, order #", "tribe-events-calendar" ) );
			//JER added specific barcode box
			echo sprintf( '%s: <input type="text" name="filter_barcode" id="filter_barcode" value="">', __( "Barcode", "tribe-events-calendar" ) );
			echo '</div>';
